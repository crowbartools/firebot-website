            ...
            <div className="h-full text-white relative mx-3 xl:mx-auto lg:max-w-6xl mt-8 lg:mt-16 pb-10">
                <AnimatePresence>
                    {profileStore.unableToLoad && (
                        ...
                        >
                            <div className="bg-gray-800 rounded-md py-10 px-20 flex flex-col items-center max-w-sm">
                                <FontAwesomeIcon
                                    icon={faFrown}
                                    className="text-9xl text-red-400"
                                />
                ...
                <AnimatePresence>
                    {!profileStore.isLoading && !profileStore.unableToLoad && (
                        <motion.div
                            initial={{ opacity: 0.0 }}
                            animate={{ opacity: 1.0 }}
                        >
